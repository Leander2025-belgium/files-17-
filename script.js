...
function icon(name, isDay=true, size=24, cls=''){
  ...
  switch(name){
    ...
    case 'drizzle': return `<svg class="${c}" width="${s}" height="${s}" viewBox="0 0 24 24" ${stroke} style="overflow:visible"><g transform="translate(0 1.25)"><path d="M6.5 13h11a3.8 3.8 0 000-7.6 5.5 5.5 0 00-10.6-1.7A4 4 0 006.5 13z" style="color:#9fb0d1"/><path d="M9 17l-1 2.5M13 17l-1 2.5M17 17l-1 2.5" style="color:#35d0c4"/></g></svg>`;
    case 'rain': return `<svg class="${c}" width="${s}" height="${s}" viewBox="0 0 24 24" ${stroke} style="overflow:visible"><g transform="translate(0 1.25)"><path d="M6.5 12h11a3.8 3.8 0 000-7.6 5.5 5.5 0 00-10.6-1.7A4 4 0 006.5 12z" style="color:#9fb0d1"/><path d="M8 16l-1.5 4M13 16l-1.5 4M18 16l-1.5 4" style="color:#35d0c4"/></g></svg>`;
    case 'snow': return `<svg class="${c}" width="${s}" height="${s}" viewBox="0 0 24 24" ${stroke} style="overflow:visible"><g transform="translate(0 1.25)"><path d="M6.5 12h11a3.8 3.8 0 000-7.6 5.5 5.5 0 00-10.6-1.7A4 4 0 006.5 12z" style="color:#9fb0d1"/><path d="M9 17v4M7 19h4M15 17v4M13 19h4" style="color:#dfe9fb"/></g></svg>`;
    case 'storm': return `<svg class="${c}" width="${s}" height="${s}" viewBox="0 0 24 24" ${stroke} style="overflow:visible"><g transform="translate(0 1.25)"><path d="M6.5 11h11a3.8 3.8 0 000-7.6 5.5 5.5 0 00-10.6-1.7A4 4 0 006.5 11z" style="color:#9fb0d1"/><path d="M13 12l-3.5 5h3L11 21l4.5-6h-3z" fill="#f5a524" stroke="#f5a524"/></g></svg>`;
